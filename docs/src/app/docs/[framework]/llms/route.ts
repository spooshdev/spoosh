...
- [usePages](${RAW_BASE_PATH}/hooks/use-pages.mdx): Paginated data fetching
...
- [injectPages](${RAW_BASE_PATH}/injects/inject-pages.mdx): Paginated data fetching
- [injectQueue](${RAW_BASE_PATH}/injects/inject-queue.mdx): Concurrent request queues with progress tracking`;

  const infiniteQueryHook = framework === "react" ? "usePages" : "injectPages";
