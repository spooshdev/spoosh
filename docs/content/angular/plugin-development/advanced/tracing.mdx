...
When the [devtool](/docs/angular/devtool) plugin is enabled, your plugins can emit trace events to show what they're doing. This helps users understand request flow and debug issues.
