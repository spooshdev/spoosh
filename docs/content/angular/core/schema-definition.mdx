...
See the [Hono Integration](/docs/angular/integrations/hono) guide for details.
...
See the [Elysia Integration](/docs/angular/integrations/elysia) guide for details.
