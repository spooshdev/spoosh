...
export const { useRead, useWrite, usePages, useQueue, useSubscription } =
  create(spoosh);
```
...
- [useSubscription](/docs/react/hooks/use-subscription) - Subscribe to real-time data streams (SSE)
